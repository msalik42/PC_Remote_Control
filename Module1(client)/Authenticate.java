...
public void actionPerformed(ActionEvent ae){
				...
				//this code is added to start audio conversetion
				class CallAudio extends Thread{
					public void run(){
						try{
						Thread.sleep(1);
						Client c = new Client();
						c.captureAudio(cSocket.getInetAddress());
						}catch(Exception e){
							System.out.println(e);
						}
					}
				}
				CallAudio au = new CallAudio();
				au.start();
				//to this line for audio conversetion
